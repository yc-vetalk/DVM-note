/* ══════════════════════════════════════════════════════
   上群 網頁筆記 — 頂列導覽選單資料
   每個學期／站線一筆，topics 是該學期底下的科目（用於下拉選單卡片）。
   新增一個科目時，記得在對應學期的 topics 陣列補一筆
...
const SITE_NAV = [
  {
    ...
    topics: [
      ...
      { title: "豬病學", url: "大四上/豬病學/index.html", desc: "尚無筆記" },
  ...
  },
  {
    ...
    url: "index.html",
    topics: [
      { title: "解剖生理學", url: "總複習/解剖生理學/index.html", desc: "已整理 7 / 7 主題：骨骼、關節、肌肉、神經、特殊感覺、生殖、禽類解剖" },
      { title: "獸醫生理學", url: "總複習/獸醫生理學/index.html", desc: "已整理 1 / 11 主題：總論與生理恆定" }
    ]
  }
];
