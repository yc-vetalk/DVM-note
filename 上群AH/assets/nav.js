/* ══════════════════════════════════════════════════════
   上群AH — 頂列導覽選單邏輯
   讀取 nav-data.js 的 SITE_NAV，建立頂列科別分頁；有主題的
   科別點擊展開下拉卡片選單，沒有主題的科別直接是一般連結。
   使用頁面需先放一個容器：
     <div id="siteNav" class="site-nav" data-base="../" data-current="外科"></div>
   data-base：回網站根目錄的相對路徑（頂層 "" ／科別或主題頁 "../"）
   data-current：目前所在科別的 id（不在任何科別時留空）
